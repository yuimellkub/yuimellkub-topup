// Yuimellkub Firebase configuration
window.YUIMELLKUB_FIREBASE_CONFIG = {
  apiKey: "AIzaSyB2_JvGY-ttHw-32yYZ03FMDsW8R5S6BSE",
  ...
  measurementId: "G-VBPC096X50"
};

window.YUIMELLKUB_ADMIN_UID = "NK2Um4UJRnca2VLa8FPJObq6ZFm2";
