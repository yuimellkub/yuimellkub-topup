(function(){
  ...
  document.addEventListener('click',function(e){
    ...
    if(el.classList.contains('ymk-send-choice')||el.classList.contains('ymk-send-confirm'))remember(true);
    if(el.classList.contains('ready-stock-order-btn')&&el.dataset.ymkSendConfirming!=='1'&&!window.YMK_SEND_ORDER_META)remember(false);
  },true);
  ...
  function patch(){
    ...
    notice.innerHTML='<div style="font-size:14px;font-weight:900;text-align:center;margin-bottom:5px">📦 สำหรับออเดอร์แบบส่ง</div>กรุณาติดต่อทางร้านเพื่อแจ้งรายละเอียด <b>สกิน / ไอเทมที่ต้องการให้ส่ง</b> พร้อมแจ้งเลขออเดอร์ให้แอดมินทราบนะคะ ♡<br><br><b>หมายเหตุ:</b> แบบส่งจำเป็นต้องแอดเพื่อนภายในเกมและรอครบ <b>24 ชั่วโมง</b> ก่อนจึงจะสามารถส่งของขวัญได้ค่ะ 🎀';
