(function(){
  ...
  function addApprovedNote(){
    ...
    if(!note){
      ...
      note.style.cssText='margin-top:8px;text-align:center;font-size:13px;line-height:1.6;color:#9a526d;font-weight:700';
    ...
    note.textContent='ออเดอร์เข้าสู่ระบบแล้ว • กรุณารอดำเนินการเติมเกม ♡';
  }
